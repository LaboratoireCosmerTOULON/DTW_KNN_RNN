...
python3 dtw_samediver_script.py --window $window_size --neighbors $neighbors --subject $subject --data_directory $data_type --yaml $yaml_file --output $output --signal_ith $signal_number
